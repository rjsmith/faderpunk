...
export const UpdateGuide = () => {
  const firmwareLatestVersion = useLatestFirmwareVersion();
  ...
  return (
    <>
      ...
      <p>
        This guide will walk you through updating your Faderpunk's firmware.
        Don't worry—it's simpler than it sounds! You'll essentially be copying a
        file to your device while it's in a special update mode.
      </p>
      <H3 id="download">Download latest firmware</H3>
      <ButtonPrimary
        as="a"
        href={`https://github.com/ATOVproject/faderpunk/releases/download/faderpunk%2Fv${firmwareLatestVersion}/faderpunk-v${firmwareLatestVersion}.uf2`}
      >
        Download v{firmwareLatestVersion}
      </ButtonPrimary>
      ...
      <p className="mb-2">
        This is a special mode that allows your Faderpunk to receive new
        firmware.
      </p>
      <ol className="mb-4 list-inside list-decimal space-y-1">
        ...
        <li>
          <strong>Keep holding Shift</strong> for about 2-3 seconds after
          plugging in
        </li>
      ...
      <p className="mb-2">
        Your computer will now recognize the Faderpunk as a storage device (like
        a USB flash drive) named <strong>RP2350</strong>.
      </p>
      ...
      <List>
        ...
        <li>
          Look in the left sidebar under "This PC" or "Devices and drives"
        </li>
        <li>
      ...
      <List>
        ...
        <li>
          Alternatively, open <strong>Finder</strong> and look in the left
      ...
      <ol className="mb-4 list-inside list-decimal">
        ...
        <li>
          ...
          update was successful. You'll find the version in the Settings tab,
